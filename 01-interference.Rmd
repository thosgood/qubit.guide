...
1. To start with, consider the setup in Figure \@ref(fig:mach-zehnder-bomb-tester), where the input and output ports are hooked up in the lower arm of a Mach-Zehnder interferometer.^[Read about a Mach-Zehnder interferometer in the supplementary material.]
...
It gets the answer wrong with a probability not greater than $\half-\delta$, where $\delta>0$ is a constant.^[This result is known as the **Chernoff bound**].
