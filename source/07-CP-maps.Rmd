...
- *A bit-flip with probability $p$*, given by $\mathcal{E}(\rho)=(1-p)\rho+pX\rho X$.
...
- *A phase-flip with probability $p$*, given by $\mathcal{E}(\rho)=(1-p)\rho+pZ\rho Z$.
...
- *The depolarising channel*, given by
    $$
...
::: {.idea latex=""}
Describing actions of quantum channels in terms of their effects can be ambiguous.
:::
...
This is due to *complete* positivity (instead of just "positivity") of quantum channels, which we will explain shortly.


## Composition quantum channels
