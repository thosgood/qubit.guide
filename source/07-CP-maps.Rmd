...
::: {.idea latex=""}
If $\mathcal{E}\colon\mathcal{B}(\mathcal{H})\to\mathcal{B}(\mathcal{H'})$, and $d=\dim\mathcal{H}$, then
$$
  \mathcal{E}(\rho)
...
Now, any vector $\ket{\psi}$ in $\mathcal{H}\otimes\mathcal{H}'$ can be written as
$$
...
::: {.tim}
**Exercise.**
Prove that we can always write such vectors in this form.
:::
...
$$
Moreover, $\tr\widetilde{\mathcal{E}}=1$ implies that $\sum_k E^\dagger_kE_k=\id$.

::: {.tim}
**Exercise.**
Prove this: $\tr\widetilde{\mathcal{E}}=1\implies\sum_k E^\dagger_kE_k=\id$.
:::
