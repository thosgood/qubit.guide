...
here, with $\ket{k}$ fixed, it is only the $k$-th column of the block matrix $U$ that determines the evolution of $\mathcal{B}$, as shown in \@ref(fig:unitary-isometry).

(ref:unitary-isometry-caption) For $k=2$, the second block column is selected.

```{r unitary-isometry,engine='tikz',fig.width=4,fig.cap='(ref:unitary-isometry-caption)'}
