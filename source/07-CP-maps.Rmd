...
$$
Then take $A$ and $B$ to be the block matrices $\rho\otimes\id$ and $\widetilde{\mathcal{E}}$, respectively; we can show that
$$
...
$$
where $ket{\Omega}=\frac{1}{\sqrt d}\sum_{i=1}^d\ket{i}\otimes\ket{i}$ is the maximally entangled state in $\mathcal{H}\otimes\mathcal{H}$, and $d=\dim\mathcal{H}$.
:::
