...
In Section \@ref(three-qubit-code) we stated that the only correctable channels were individual unitaries, individual isometries, and statistical mixtures of mutually orthogonal isometries.^[The latter actually encapsulates the first two anyway.]
