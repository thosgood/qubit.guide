...
$$
  \|vw\|_1 \leq \|v\|_p\|w\|_q
$$
with equality if and only if $v$ and $w$ are "$(p,q)$-linearly dependent".^[The technical statement of Hölder's inequality is really for something known as a **measure space**, where $v$ and $w$ are *functions*, but the details aren't relevant for us here.]
:::
