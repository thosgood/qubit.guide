...
For simplicity, we're going to talk about *local* hidden variable theories --- we discuss this assumption briefly after talking about the [CHSH inequality](#chsh-inequality).
