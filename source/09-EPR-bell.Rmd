...
Consider two entangled qubits in the *singlet*^[We say that a system is *singlet* if all the qubits involved are entangled. This is related to the notion of singlet states in quantum mechanics, which are those with zero net angular momentum, i.e. with overall spin equal to zero.] state
$$
  \ket{\psi}
...
::: {.technical}
In the following overview, we are really talking about *local* hidden variable theories --- we discuss this assumption briefly after talking about the [CHSH inequality](#chsh-inequality).
:::
...
<lite-youtube videoid="xFj9Mf9LGso" playlabel="Play: Device-independent tests and Bell inequalities"></lite-youtube>
...
<lite-youtube videoid="P-hk1GnAE6k" playlabel="Play: Device-independent tests and Bell inequalities (continued)"></lite-youtube>
