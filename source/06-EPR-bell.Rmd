...
Explain how a single player (say, Alice) can treat this as a single-player game and use it as the basis for a randomness expansion scheme.^[*Hint: unlike in the quantum key distribution scenario from Exercise \@ref(xor-games-for-qkd)*, Alice no longer needs to choose a random subset of rounds to check the winning condition for: she can check all of them.]
