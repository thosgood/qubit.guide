...
Also recall that any single-qubit observable^[Here we say "observable" instead of "Hermitian operator" (and "value" instead of "eigenvalue") simply because it is a useful skill to be able to switch between being able to speak like a mathematician and like a physicist!] with values $\pm1$ can be represented by the operator
$$
