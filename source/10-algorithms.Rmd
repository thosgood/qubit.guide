...
- function evaluation;
- another Hadamard (or Fourier) transform.^[As explained in Section \@ref(quantum-fourier-transforms), the Hadamard transform is a special case of the Fourier transform over the group $\mathbb{Z}_2^n$.]
...
where $U^\triangle$ is defined below, and $FT^\dagger$ is defined in \@ref(quantum-fourier-transform).
::::

::: {.todo}
<!-- TO-DO: define U^\triangle -->
:::

::: {.todo}
<!-- TO-DO: note that you can't efficiently implement U^\triangle if all you have is U ! -->
:::
