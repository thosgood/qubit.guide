...
$$
  ...
  \end{aligned}
$$
where the summation over $f(a)$ means summing over all binary strings in the image of $f$, i.e. over the set of all $z\in\{0,1\}^n$ such that there exists some $x\in\{0,1\}^n$ with $f(x)=z$.
<!-- TO-DO: but what does "a" mean then? is it just an arbitrary choice of preimage? -->
Then the final output of the algorithm is
$$
