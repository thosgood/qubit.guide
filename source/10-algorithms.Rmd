...
Following our usual credo, this last gate should look something like a Hadamard, and we shall see that it is indeed a generalisation of this.
...
(ref:example-iqft-with-measurement-caption) The gate $FT^\dagger$ followed by measurement, acting on four qubits. The double vertical lines linking gates indicate that the result of the classical measurement is used to control the application (for example, we want the phase gate on the second register to apply the phase $-\pi/2$ *multiplied by $m_n$*).
...
- **TO-DO: defn bottom of p. 238!!!!**
- **TO-DO: show it's unitary (p. 238/239)!!!!**
- **TO-DO: point out how it looks like Hadamard!!!!**
- **TO-DO: penultimate paragraph of 5.5 on p. 239!!!!**
- **TO-DO: final paragraph of 5.5 on p.239!!!!**

::: {.todo}
<!-- .technical Fourier theory in general -->
:::
