...
This means that we simply need to precede the phase gate by the $\pi/4$-phase gate^[Refer to Section \@ref(phase-gates-galore) for an explanation of this confusing terminology.] $S=\left[\begin{smallmatrix}1&0\\0&i\end{smallmatrix}\right]$.
