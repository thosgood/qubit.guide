...
For example, the rank-$1$ pure states form a connected set on the surface which lies a maximum distance of $\sqrt{2}$ from the maximally mixed state $\frac13\id$, and the other points on the surface correspond to rank-$1$ and rank-$2$ operators, with the points strictly inside corresponding to rank-$3$ (i.e. full rank) operators.
