...
Nevertheless, the construction is both interesting and useful (and very recent!) --- see the following paper for more:

> C Eltschka, M Huber, S Morelli, and J Siewert, "The shape of higher-dimensional state space: Bloch-ball analog for a qutrit". *Quantum* **5** (2021), DOI: [10.22331/q-2021-06-29-485](https://doi.org/10.22331/q-2021-06-29-485).
:::

We can still use the Bloch ball when working with *multiple* qubits at once, but we have to be careful because things don't always work nicely, precisely because the state space of multiple qubits is *not* just a product of Bloch balls.
...
Now, take some orthonormal (with respect to the Hilbert--Schmidt inner product $(A|B)=\frac12\tr A^\dagger B$) basis $\{M_i\}$ of the space of Hermitian matrices.
