...
If we have $n$ qubits, then we can describe the corresponding product state in terms of $n$ vectors in the Bloch ball, but this method only lets us describe *product* states of the $n$ qubits --- [we've already seen](#separable-or-entangled) that, as $n$ grows larger, "most" states are *not* separable!
