...
$$
  ...
  = \frac{1}{d}\sum_{ij}\rho_{ij}\mathcal{E}(\ket{i}\bra{j}).
$$
...
$$
  \ket{\Omega}\coloneqq\frac{1}{d}\sum_{i=1}^d\ket{i}\ket{i}
$$
...
$$
  ...
  \\&= \frac{1}{d} \sum_{ij} \left(\ket{i}\bra{j}\otimes\underbrace{\sum_k E_k(\ket{i}\bra{j}) E^\dagger_k}_{\mathcal{E}(\ket{i}\bra{j})}\right).
  \end{aligned}
$$
