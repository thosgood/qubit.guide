...
$$
where $V=\sum_{i,j}V_{ij}\ket{j}\bra{i}$ is an operator from $\mathcal{H}$ to $\mathcal{H}'$.
...
$$
  ...
  \\&= \frac{1}{d} \sum_{i,j} \left(\ket{i}\bra{j}\otimes\underbrace{\sum_k E_k(\ket{i}\bra{j}) E^\dagger_k}_{\mathcal{E}(\ket{i}\bra{j})}\right).
  \end{aligned}
$$
