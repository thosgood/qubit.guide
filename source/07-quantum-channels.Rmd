...
In fact, not just any density matrix: the first subsystem of the maximally entangled state $\ket{\Omega}$ remains maximally mixed, since we apply the identity operator, and so $(\id\otimes\tr)\widetilde{\mathcal{E}}=\frac{1}{d}\id$.
...
For the trace-preserving correspondence, note that
