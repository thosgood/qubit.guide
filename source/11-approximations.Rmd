...
Again, this upper bound is attained by taking $P_0$ to be the projector onto the eigenspace of $\rho_0-\rho_1$ corresponding to the *positive* eigenvalues, and $P_1$ the projector corresponding to the *negative* eigenvalues --- this gives $\tr(P_0-P_1)(\rho_0-\rho_1)=\|\pho_0-\rho_1\|_{\tr}$.
...
So, at the very least, we want $\varepsilon<\frac{1}{2}\delta$!
...
**TO-DO: recall Section \@ref(the-schmidt-decomposition)**
