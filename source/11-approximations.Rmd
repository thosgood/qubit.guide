...
We leave the proof that this is indeed a metric as an exercise (\@ref(hamming-distance)).
...
Show that the Hamming distance (defined in \@ref(metrics)) is indeed a metric.
