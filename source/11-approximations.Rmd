...
$$
  d(\rho,\sigma) \coloneqq \frac{1}{2}\|\rho-\sigma\|_\tr.
$$
:::
...
$$
  ...
  \\&\eqqcolon d(\rho,\sigma)
  \end{aligned}
$$
which says that the trace distance $d(\rho,\sigma)$ gives an upper bound on distances between probability distributions obtained from $\rho$ and $\sigma$ by a measurement.
