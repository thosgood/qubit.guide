...
There are four conditions governing metrics (note that identity of indiscernibles is an "if and only if" statement, so we can separate it into two "if" statements).
...
::: {.idea latex=""}
[**Hölder's inequality**](https://en.wikipedia.org/wiki/H%C3%B6lder's_inequality).
