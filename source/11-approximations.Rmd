...
**TO-DO: define trace norm (sum of singular values) BUT NOTHING MORE --- we will talk about how it relates to the trace distance (for probability distributions) and the operator/spectral norm (introduced in Section \@ref(approximating-unitaries)) later, in Section \@ref(more-operator-norms)**
