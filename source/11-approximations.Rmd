...
We have already seen, all the way back in \@ref(modifying-the-born-rule)^[Think how far you've come since then!], how the Euclidean norm (from which we get the Euclidean distance) is the special case $p=2$ of $p$-norms (also known as $\ell^p$-norms), where
$$
...
\end{tikzpicture}
```
**TO-DO: mention Hölder's inequality**
...
**TO-DO: first discuss norms 1 and 2 (p.16)**

**TO-DO: now point out that they're all [**Schatten $p$-norms**](https://en.wikipedia.org/wiki/Schatten_norm)**

**TO-DO: short explanation of what it means to have so many different norms! are they equivalent? etc.**

**TO-DO: example on p.17**
