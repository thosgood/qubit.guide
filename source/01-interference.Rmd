...
$$
  ...
  \end{aligned}
$$
and then using the trick of writing $x=\frac{x+y}{2}+\frac{x-y}{2}$ and $y=\frac{x+y}{2}-\frac{x-y}{2}$, followed by using Euler's formula^[$e^{i\alpha}=\cos\alpha+i\sin\alpha$], gives us that
$$
  \begin{aligned}
    U_{10}
  \\&= \frac12 \left(e^{i\varphi_0}-e^{i\varphi_1}\right)
