...
$$
  ...
  + \underbrace{\sum_{\substack{ k > j}} \left( z_k^\star z_j + z_j^\star z_k\right)}_{\substack{\text{non-diagonal}\\ \text{elements}}}
  ...
  \\&= \sum_k p_k + \sum_{k > j} 2 \sqrt{p_k p_j}\cos(\varphi_k-\varphi_j).
  \end{aligned}
$$
