...
> *"Computation is a physical process. Computation is a physical process. Computation is ..."*
:::
...
<lite-youtube videoid="XrKl38ZVofo" playlabel="Play: Probablity amplitudes"></lite-youtube>

<lite-youtube videoid="N6qhce2HNQQ" playlabel="Play: Probablity amplitudes (continued)"></lite-youtube>
...
<lite-youtube videoid="T2vpnfX3lJA" playlabel="Play: Ramsey interferometry"></lite-youtube>

<lite-youtube videoid="TWVL7u06BB4" playlabel="Play: Ramsey interferometry via matrices"></lite-youtube>
...
<lite-youtube videoid="7uzQQvDXPk0" playlabel="Play: Circuit diagrams and matrix multiplication"></lite-youtube>
...
In the presence of decoherence, the interference formula in [Equation (1.2.1.1)](#the-double-slit-experiment) is modified and reads
$$
...
<lite-youtube videoid="v6-tQj--yoI" playlabel="Play: Deterministic, probabilistic, and quantum computation"></lite-youtube>
...
<lite-youtube videoid="220Io4rxzrQ" playlabel="Play: Complexity classes"></lite-youtube>
...
### Complex numbers {#complex-numbers-exercise}
...
Mathematically speaking, the set of complex numbers is a **field**.
...
::: {.technical}
**TO-DO** explain this lovely hierarchy going from sets to monoids to ... to fields; also explain $\{*\}\hookrightarrow\mathbb{N}\hookrightarrow\mathbb{Z}\hookrightarrow\mathbb{Q}\hookrightarrow\mathbb{R}\hookrightarrow\mathbb{C}$.
:::

a. The set of rational numbers and the set of real numbers are both fields, but the set of integers is not. Why not?
...
Let us call this logic gate **the square root of $\texttt{NOT}$**, or $\sqrt{\texttt{NOT}}$ (since it defined exactly to satisfy $\sqrt{\texttt{NOT}}^2=\texttt{NOT}$).
...
Thus, quantum theory declares, the square root of $\texttt{NOT}$ actually *is* possible.
...
(We will answer this question when we introduce [the Mach--Zender interferometer](#beamsplitters-against-logic).)
