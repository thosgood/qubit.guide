...
(ref:single-bit-flip-complete-circuit-caption) The quantised version of the classical $[3,1,3]$-code. If *at most one* bit-flip error occurs in the shaded region, then this circuit perfectly corrects it, resulting in the successful transmission of the state $\alpha\ket{0}+\beta\ket{1}$.
...
\\
  ...
  & \ctrl{1}
  & \ctrl{2}
  & \gate[3,style={dashed,fill=primary!20}]{X\text{ error}}\gategroup[3,style={draw=none,rounded corners,fill=primary!20,inner xsep=6pt},background]{}
  & \qw
  & \ctrl{-2}
  & \qw
  & \qw
...
## Turning phase-flips to bit-flips
