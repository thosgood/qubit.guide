...
\begin{tikzpicture}
  \begin{scope}[shift={(-9,0)}] % the figure on the left-hand side
    \node [draw, minimum width=1cm,thick,minimum height=1cm] at (0,0.75) (start) {$\mathcal{H}$};
    \node [draw, minimum width=1cm,thick,minimum height=1cm,rotate=15] at (4,2) (a) {$\mathcal{H}_1$};
    \node [draw, minimum width=1cm,thick,minimum height=1cm,rotate=0] at (5.5,1.5) (b) {$\mathcal{H}_2$};
    \node [draw, minimum width=1cm,thick,minimum height=1cm,rotate=-10] at (4,0) (c) {$\mathcal{H}_3$};
    \node [draw, minimum width=1cm,thick,minimum height=1cm,rotate=45] at (5.5,-0.5) (d) {$\mathcal{H}_4$};
  ...
  \begin{scope} % the figure on the right-hand side
    ...
    \begin{scope}
      ...
      \pgfnode{rectangle}{center}{}{nodename}{\pgfusepath{stroke,clip}}
      \pgftransformreset
      \node [draw,fill=primary, minimum width=1cm,thick,minimum height=1cm,rotate=45] at (5.25,-0.5) {};
    \end{scope}
    \node [draw, minimum width=1cm,thick,minimum height=1cm] at (0,0.75) (start) {$\mathcal{H}$};
    \node [draw, minimum width=1cm,thick,minimum height=1cm,rotate=15] at (4,2) (a) {$\mathcal{H}_1$};
    \node [draw, minimum width=1cm,thick,minimum height=1cm,rotate=0] at (4.85,1.5) (b) {$\mathcal{H}_2$};
    \node [draw, minimum width=1cm,thick,minimum height=1cm,rotate=-10] at (4.5,0) (c) {$\mathcal{H}_3$};
    \node [draw, minimum width=1cm,thick,minimum height=1cm,rotate=45] at (5.25,-0.5) (d) {$\mathcal{H}_4$};
    \draw [->,thick] (start) to[out=60,in=150] node [midway,above] {$V_1$} (a);
    \draw [->,thick] (start) to[out=20,in=-150] node [pos=0.3,above] {$V_2$} (b);
    \draw [->,thick] (start) to[out=-60,in=-150] node [midway,above] {$V_3$} (c);
    \draw [->,thick] (start) to[out=-80,in=-110] node [midway,above] {$V_4$} (d);
    \node[draw=secondary,inner sep=7pt,thick,ellipse,fit=(a) (b) (c) (d),label={above:$\mathcal{H}'$}] {};
  \end{scope}
\end{tikzpicture}
```
