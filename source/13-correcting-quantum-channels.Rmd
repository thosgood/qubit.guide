...
## Protecting against bit-phase-flips with Shor [[9,1,3]] {#protecting-against-bit-phase-flips}
...
Rather than drawing the entire circuits from Sections \@ref(protecting-against-bit-flips) and \@ref(protecting-against-phase-flips) again, let's simply draw them as consisting of an encoding gate $C$ and a decoding gate $D$, separated by a zone $[t_1,t_2]$ that corresponds to transmission over the noisy channel.
...
This is known as **fault tolerance**, and we will start our journey towards studying it, using the stabiliser formalisation of Section \@ref(stabilisers), in Section \@ref(fault-tolerant-quantum-computation).
