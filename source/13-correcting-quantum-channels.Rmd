...
Often combined with this is the problem of **state preparation**^[The combination of state preparation and measurement errors is sometimes called **SPAM**. This can be dealt with in various ways, since their effect does not get worse as circuit depth increases.] --- how do we know that we really are preparing the state that we call $\ket{0}$?
