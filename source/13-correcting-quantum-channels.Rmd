...
\begin{tikzpicture}[decoration={snake,segment length=2mm,amplitude=0.5mm,pre length=3mm,post length=3mm}]
  \begin{scope}
    ...
    \node at (1,-2) {$\ket{\psi}\ket{e}\ket{a}$};
  \end{scope}
  ...
  \begin{scope}[shift={(4,0)}]
    ...
    \node at (1,-2) {$\sum_iE_i\ket{\psi}\ket{e_i}\ket{a}$};
  \end{scope}
  ...
  \begin{scope}[shift={(8,0)}]
    ...
    \node at (1,-2) {$\sum_{i,k}R_kE_i\ket{\psi}\ket{e_i}\ket{a_k}$};
  \end{scope}
\end{tikzpicture}
```
...
```{r decoherence-recoherence-desired-outcome,engine='tikz',fig.width=2.6,fig.cap='(ref:decoherence-recoherence-desired-outcome-caption)'}
\newcommand{\ket}[1]{|#1\rangle}
\begin{tikzpicture}[decoration={snake,segment length=2mm,amplitude=0.5mm,pre length=3mm,post length=3mm}]
  \node[draw,thick,primary,circle] (S) at (0,0) {$\mathcal{S}$};
  \node[draw,thick,primary,circle] (A) at (2,1) {$\mathcal{A}$};
