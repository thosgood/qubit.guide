...
::: {.todo latex=""}
<!-- TO-DO: we're assuming that only single-qubit errors occur, but ALSO that no errors affect our ancilla bits when we do syndrome measurement, and also that we have no measurement errors, and also that all our gates are correctly implemented, and also ... -->
<!-- TO-DO: we'll look at how to deal with the first assumption in the next section, but the others? eesh -->
:::
