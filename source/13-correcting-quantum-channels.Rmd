...
(ref:313-all-3-bit-strings-caption) All the $3$-bit strings that are within Hamming distance $1$ from $000$ are below the line, and all those that are within Hamming distance $1$ from $111$ are above the line. The decoding process assumes that the former are corrupted versions of $000$, and the latter of $111$.
