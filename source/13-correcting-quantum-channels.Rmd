...
Here is a simple but important example: the **three-qubit code**.^[We will return to this example, using the language of stabilisers from Chapter \@ref(stabilisers), in Chapter \@ref(fault-tolerant-quantum-computation).]
...
Before we can describe fully fault-tolerant computation, we need to be able to deal with these more complicated scenarios, and this forms the topic of a large chunk of Section \@ref(fault-tolerant-quantum-computation).
