...
We are particularly interested in any *finite* universal set of gates^[One particular example that we will see again is the Hadamard, $\texttt{c-NOT}$, and $T=P_{\pi/4}$.] that can approximate any unitary operation on $n$ qubits with arbitrary precision.
