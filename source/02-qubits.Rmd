...
In words, the state $\ket{k}$ evolves into the specific state $\ket{l}$ with probability amplitude $U_{lk}$ and probability $|U_{lk}|^2$,
so the whole situation is described by the superposition (i.e. the sum) of all of these.
...
The gates in a circuit can be divided into layers. Gates in the same layer operate at the same time.
