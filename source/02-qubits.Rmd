...
In words, the state $\ket{k}$ evolves into the specific state $\ket{l}$ with probability $U_{lk}$, so the whole situation is described by the superposition (i.e. the sum) of all of these.
