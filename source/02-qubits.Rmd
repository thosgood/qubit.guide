...
|  |  |  |
|:-|:-|:-|
**Hadamard** | $H = \frac{1}{\sqrt2}\begin{bmatrix}1&1\\1&-1\end{bmatrix}$ | $\begin{array}{lcr}\ket{0}&\longmapsto&\frac1{\sqrt{2}}(\ket{0}+\ket{1})\\\ket{1}&\longmapsto&\frac1{\sqrt{2}}(\ket{0}-\ket{1})\end{array}$ | $\begin{array}{lcr}\ket{0}&\longmapsto&\frac{1}{\sqrt{2}}(\ket{0}+\ket{1})\\\ket{1}&\longmapsto&\frac{1}{\sqrt{2}}(\ket{0}+\ket{1})\end{array}$
