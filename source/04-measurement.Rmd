...
5. *Continuity.* Given any two pure^[All of the states that we have been discussing so far are **pure states**, but we define what this means in Section \@ref(definitions).] states of a system, there exists a continuous reversible transformation of the system that sends one to the other.
