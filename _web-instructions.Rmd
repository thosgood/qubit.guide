...
These videos are hidden by default, but if there are any on the current page, then a "Toggle Videos" button will appear in the top toolbar, which can be used to show/hide all videos on the current page.
