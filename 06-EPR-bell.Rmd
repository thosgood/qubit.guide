...
> Upper bound on _classical_ correlations.
...
\]
We choose vectors $\vec{a}_1$, $\vec{a}_2$, $\vec{b}_1$, and $\vec{b}_2$ as shown in **!!!TODO!!!**, and then, with these choices,
$$
\begin{gathered}
  \av{A_1\otimes B_1}
  = \av{A_2\otimes B_1}
...
> Upper bound on _quantum_ correlations.
