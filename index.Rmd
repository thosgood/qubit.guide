...
output:
  bookdown::gitbook:
    ...
    config:
      ...
      info: no
  bookdown::pdf_book:
    template: a4-latex-template.tex
...
<!-- TO-DO: write about intended audience and our philosophy of what this book is aiming to do -->
...
Some of these fundamentals are covered [at the end of this chapter](#preliminaries).
...
Here we quickly recall most of the fundamental mathematical results that we will rely on in the rest of this book, namely *linear algebra over the complex numbers*.
