...
author: "[Artur Ekert](https://www.arturekert.org/), [Tim Hosgood](https://thosgood.com), [Alastair Kay](http://www.ma.rhul.ac.uk/akay/), [Chiara Macchiavello](https://fisica.unipv.it/personale/Persona.php?ID=55)"
...
- *[New content]* Sections \@ref(correcting-quantum-channels) and \@ref(fault-tolerant-quantum-computation): correctable channels, repetition codes, the Shor code, the Hamming code, the CSS construction, fault tolerance; corresponding exercises
