...
<!-- TO-DO: talk about .technical divs in general (i.e. things that you can skip, but often just point to further reading) -->
...
This means that we need to introduce negative versions of all of our natural numbers, and gives us the **abelian group** of **integers**, denoted^[The choice of the letter "Z" comes from the German word *Zahlen*, meaning "numbers".] $\mathbb{Z}$.
