...
Hosting of this online book was made possible by the [Centre for Quantum Technologies](https://cqt.quantumlah.org/), [Oxford University Mathematics](https://www.maths.ox.ac.uk/), and the [Okinawa Institute of Science and Technology](https://www.oist.jp/).

```{r, out.width='32.8%', fig.show='hold'}
