...
**TO-DO: complex numbers as "real numbers plus imaginary numbers" (fund thm of alg, say the phrase "algebraically closed field")**

**TO-DO: rectangular coordinates**

**TO-DO: polar coordinates**

**TO-DO: equations to convert between rectangular and polar (i.e. trigonometry)**
