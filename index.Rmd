...
- *[New content]* Sections \@ref(quantum-randomness) to \@ref(remarks-and-exercises-bell): quantum randomness, device independence, and Bell test loopholes; corresponding exercises
- *[New content]* Sections \@ref(phase-estimation) to \@ref(shors-algorithm): phase estimation, (inverse) quantum Fourier transform, hidden order determination, and Shor's algorithm
- *[New content]* Section \@ref(approximate-phase-estimation): approximate phase estimation
- *[New content]* Section \@ref(correcting-quantum-channels): correctable channels, decoherence and interference, classical [3,1,3]-code, and Shor [[9,1,3]]-code; corresponding exercises
- *[New content]* Section \@ref(fault-tolerant-quantum-computation): Hamming codes, linear codes, CSS codes, logical states and operators, error-correcting conditions, error-protected encoding, transversal gates, surface codes; corresponding exercises
- Reordered some chapters and parts
...
::: {.todo latex=""}
<!-- TO-DO: .technical about measure spaces -->
:::
::::
...
::: {.todo latex=""}
<!-- TO-DO: .technical about Pascal's triangle -->
:::
::::
...
Given two events $A$ and $B$, we define the **conditional probability $P(B|A)$**, of **$B$ given $A$**, to be the probability that $A$ occurs *assuming that $B$ has just previously occurred*.
...
::: {.todo latex=""}
<!-- TO-DO: .technical about diagrammatic probability theory -->
:::
::::
