...
We thank the following for their helpful comments and corrections, as well as for catching typos: Zhenyu Cai, Jedrzej Burkat, Maryam Khaqan, Rolando Reiner, Jan Baltussen, Linus Kelsey, Edgardo Deza, Elizabeth Ealing, L.L. Salcedo.
...
Hosting of this online book was made possible by the [Centre for Quantum Technologies](https://cqt.quantumlah.org/), the [University of Oxford Mathematical Institute](https://www.maths.ox.ac.uk/), and the [Okinawa Institute of Science and Technology](https://www.oist.jp/).

```{r, out.width='28%', fig.show='hold'}
knitr::include_graphics('images/cqt.png')
knitr::include_graphics('images/oxford-maths.png')
knitr::include_graphics('images/oist.png')
```
