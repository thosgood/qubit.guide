...
- *[New content]* Sections \@ref(phase-estimation) to \@ref(shors-algorithm): phase estimation, (inverse) quantum Fourier transform, and Shor's algorithm
- Reordered some chapters
