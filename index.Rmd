...
- *[New content]* Section \@ref(decoherence-and-recoherence): correctable channels, decoherence and interference, classical [3,1,3]-code, and Shor [[9,1,3]]-code; corresponding exercises
- *[New content]* Section \@ref(error-correction): Hamming codes, linear codes, CSS codes, logical states and operators, error-correcting conditions, error-protected encoding, surface code; corresponding exercises
- *[New content]* Section \@ref(fault-tolerance): logical computation, magic state distillation, fault-tolerant measurement, concatenated codes, toric code; corresponding exercises
