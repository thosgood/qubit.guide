...
Suppose you are given a single qubit in some unknown quantum state $\ket{\psi}$.
Can you determine $\ket{\psi}$?


### {}

You measure a random qubit in the standard basis and register $\ket{0}$.
What does it tell you about the pre-measurement state $\ket{\psi}$?


### {}

How many real parameters do you need to determine $\ket{\psi}$?
...
You are given zillions of qubits, all prepared in the same quantum state $\ket{\psi}$.
...
### The values of $\sigma_x$ and $\sigma_y$ of a qubit
