...
We can represent this construction of $\rho'_{AB}$ diagrammatically^[In fact, a _lot_ of quantum information theory can be converted into similar looking diagrams, using the formalism of **string diagrams** from **category theory**. A very related concept is that of [ZX-calculus](https://zxcalculus.com/intro.html).] as follows:
...
\begin{equation*}
  ...
  \\\lstick{$$}& & \qw &\gate{\mathcal{E}}  & \qw &\qw \rstick{$$}\\
  \end{tikzcd}
\end{equation*}
```
