...
- **Reduction.**
    ...
    If $\rho\in \mcB(\mathcal{H}\otimes\mathcal{H}_E)$ is a joint state of the system and the environment (the two may be entangled), then we can neglect or discard the environment by tracing over it:
    $$
      \begin{aligned}
        \rho
        &\longmapsto \tr_E\rho
