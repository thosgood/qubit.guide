...
The probabilities sum up to one ($\sum_k p_k=\bra{\psi}E^\dagger_k E_k\ket{\psi} =1$) for any state $\ket{\psi}$, and so the operators $E_k$ must satisfy the completeness relation
$$
