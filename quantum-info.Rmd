...
```{r,engine='tikz',fig.width=3,fig.align='center'}
...
```{r,engine='tikz',fig.width=2.25,fig.align='center'}
\definecolor{primary}{RGB}{177,98,78}
\tikzset{blob/.style args={#1}{circle,draw,fill={#1}}}
\tikzset{process/.style={thick,->,shorten >=0.1cm,shorten <=0.1cm}}
\begin{tikzpicture}
...
```{r ramsey-figure,engine='tikz',fig.align='center',fig.cap='(ref:ramsey-figure-caption)'}
\definecolor{primary}{RGB}{177,98,78}
...
```{r ramsey-figure-2,engine='tikz',fig.align='center',fig.cap='(ref:ramsey-figure-2-caption)'}
\definecolor{primary}{RGB}{177,98,78}
\definecolor{secondary}{RGB}{91,132,177}
...
```{r interference-matrix,engine='tikz',fig.fullwidth=TRUE,fig.cap='(ref:interference-matrix-caption)'}
\definecolor{primary}{RGB}{177,98,78}
\definecolor{secondary}{RGB}{91,132,177}
\tikzset{blob/.style args={#1}{circle,draw,fill={#1}}}
\tikzset{dot/.style={fill,shape=circle,minimum size=5pt,inner sep=0pt}}
...
```{r,engine='tikz',fig.width=1.5,fig.align='center'}
\definecolor{primary}{RGB}{177,98,78}
\tikzset{blob/.style args={#1}{circle,draw,fill={#1}}}
\tikzset{process/.style={thick,->,shorten >=0.1cm,shorten <=0.1cm}}
...
```{r,engine.opts=list(template="tikz2pdf.tex"),engine='tikz',fig.width=4,fig.margin=TRUE}
\definecolor{secondary}{RGB}{91,132,177}
\begin{tikzpicture}
  \begin{axis}[
    xmin=0,xmax=5,
...
```{r deterministic-computation,engine='tikz',fig.align='center',fig.cap='Deterministic computation.'}
...
```{r probabilistic-computation,engine='tikz',fig.align='center',fig.cap='Probabilistic computation.'}
\tikzset{dot/.style={fill,shape=circle,minimum size=5pt,inner sep=0pt}}
\begin{tikzpicture}[xscale=2.5,yscale=0.8]
  \foreach \x in {0,...,5}
    \foreach \y in {0,1,2,3}
...
```{r quantum-computation,engine='tikz',fig.align='center',fig.cap='Quantum computation.'}
\tikzset{dot/.style={fill,shape=circle,minimum size=5pt,inner sep=0pt}}
\begin{tikzpicture}[xscale=2.5,yscale=0.8]
  \foreach \x in {0,...,5}
    \foreach \y in {0,1,2,3}
...
```{r,engine='tikz',fig.margin=TRUE,fig.width=2}
\begin{tikzpicture}
...
```{r photons-from-stars,engine='tikz',fig.align='center',fig.width=3.5,fig.cap='Two photon detectors pointing at two stars, with the probabilities of detection.'}
...
```{r sqrt-not,engine='tikz',fig.align='center',fig.cap='(ref:sqrt-not-caption)'}
\tikzset{dot/.style={fill,shape=circle,minimum size=5pt,inner sep=0pt}}
...
```{r bomb-detecting-scenario,engine='tikz',fig.align='center',fig.cap='(ref:bomb-detecting-scenario-caption)'}
\usetikzlibrary{arrows.meta}
\usetikzlibrary{shapes}
\definecolor{secondary}{RGB}{91,132,177}
...
```{r mach-zehnder-bomb-tester,engine='tikz',fig.align='center',fig.cap='The Mach-Zehnder interferometer hooked up to the bomb-testing room.'}
\usetikzlibrary{arrows.meta}
...
```{r decoherence-interference,engine='tikz',fig.width=4,fig.align='center',fig.cap='The usual interference experiment, but with decoherence.'}
\tikzset{dot/.style={fill,shape=circle,minimum size=5pt,inner sep=0pt}}
\tikzset{operator/.style={draw,fill=white}}
\newcommand{\ket}[1]{|#1\rangle}
\begin{tikzpicture}
...
```{r visibility-suppression,engine='tikz',engine.opts=list(template="tikz2pdf.tex"),fig.margin=TRUE,fig.width=4,fig.cap='Visibility suppression.'}
\definecolor{primary}{RGB}{177,98,78}
\definecolor{secondary}{RGB}{91,132,177}
\begin{tikzpicture}
  \begin{axis}[
...
```{r,engine='tikz',engine.opts=list(template="tikz2pdf.tex"),fig.width=8,fig.align='center'}
\begin{equation*}
  \begin{quantikz}
