...
```{r,echo=FALSE,cache=TRUE,engine='tikz',fig.width=3,fig.margin=TRUE,fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png'}
\definecolor{primary}{RGB}{177,98,78}
...
```{r,echo=FALSE,cache=TRUE,engine='tikz',fig.width=2.5,fig.align='center',fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png'}
...
```{r,echo=FALSE,cache=TRUE,engine='tikz',fig.width=5,fig.align='center',fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png'}
\tikzset{operator/.style={draw,fill=white}}
\newcommand{\ket}[1]{|#1\rangle}
\begin{tikzpicture}
...
```{r universal-circuit-for-2-by-2,echo=FALSE,cache=TRUE,engine='tikz',fig.width=5,fig.align='center',fig.cap='(ref:universal-circuit-for-2-by-2-caption)',fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png'}
\tikzset{operator/.style={draw,fill=white}}
\tikzset{dot/.style={fill,shape=circle,minimum size=5pt,inner sep=0pt}}
...
```{r bloch-sphere,echo=FALSE,cache=TRUE,engine='tikz',fig.width=4.5,fig.align='center',fig.cap='(ref:bloch-sphere-caption)',fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png'}
\usetikzlibrary{arrows.meta}
\tikzset{dot/.style={fill,shape=circle,minimum size=5pt,inner sep=0pt}}
\definecolor{primary}{RGB}{177,98,78}
\definecolor{secondary}{RGB}{91,132,177}
...
```{r bloch-sphere-rotation,echo=FALSE,cache=TRUE,engine='tikz',fig.width=5,fig.align='center',fig.cap='(ref:bloch-sphere-rotation-caption)',fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png'}
\usetikzlibrary{arrows.meta}
\definecolor{primary}{RGB}{177,98,78}
\definecolor{secondary}{RGB}{91,132,177}
\begin{tikzpicture}
