...
| :------: | :---: |
| $H$ | $P_\varphi$ |
| $\frac{1}{\sqrt2}\begin{bmatrix}1&1\\1&-1\end{bmatrix}$ | $\begin{bmatrix}1&0\\0&e^{i\varphi}\end{bmatrix}$ |
| $\begin{array}{lcr}\ket{0}&\longmapsto&\frac1{\sqrt{2}}(\ket{0}+\ket{1})\\\ket{1}&\longmapsto&\frac1{\sqrt{2}}(\ket{0}-\ket{1})\end{array}$ | $\begin{array}{lcr}\ket{0}&\longmapsto&\ket{0}\\\ket{1}&\longmapsto&e^{i\varphi}\ket{1}\end{array}$ |
:::
...
| :-----------: | :--------: | :-----------: | :-----------: |
| $P_\varphi$ | $Z$ | $S$ | $T$ |
| $\begin{bmatrix}1&0\\0&e^{i\varphi}\end{bmatrix}$ | $\begin{bmatrix}1&0\\0&-1\end{bmatrix}$ | $\begin{bmatrix}1&0\\0&i\end{bmatrix}$ | $\begin{bmatrix}1&0\\0&e^{i\frac{\pi}{4}}\end{bmatrix}$ |
:::
...
| :------: | :------: | :------------: | :--------: |
| $\id$ | $X$ | $Y$ | $Z$ |
| $\begin{bmatrix}1&0\\0&1\end{bmatrix}$ | $\begin{bmatrix}0&1\\1&0\end{bmatrix}$ | $\begin{bmatrix}0&-i\\i&0\end{bmatrix}$ | $\begin{bmatrix}1&0\\0&-1\end{bmatrix}$ |
:::
