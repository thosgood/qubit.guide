...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/SkKF48vijiw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/Y52d8Awh96g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/1PJonQOi5M8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/jWzTMtFiG8k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/lbrO_0EImZ4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/sy3I932usMQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
If we do not specify the phase then we usually assume that $\varphi=\pi$, in which case we call this operation the **controlled-$Z$ gate**, which acts as $\proj{0}0\otimes\id + \proj{1}1\otimes Z$.
...
$$
  \texttt{c-}U
  =
  \proj{0}0\otimes\id + \proj{1}1\otimes U
$$
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/IzyAY6US5C4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/0AU6U7bcEh0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/lHTSQxii0t0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
- Show that, if $\ket{\psi}$ is a product state, then $\det (c_{ij}) = 0$.
- Show that the converse ($\det(c_{ij})=0$ implies that $\ket{\psi}$ is a product state) holds only for qubits. Explain why.
...
2. Deduce that the state
    $$
      \ket{\psi_k} = \frac12(\ket{00}+\ket{01}+\ket{10}+(-1)^k\ket{11})
    $$
    is entangled if and only if $k$ is odd.

3. Write down $\ket{\psi_1}$ explicitly as a product state.


### {}

Show that, for any states $\ket{\psi_1}$ and $\ket{\psi_2}$, the circuit below implements the swap operation $\ket{\psi_1}\ket{\psi_2} \mapsto \ket{\psi_2}\ket{\psi_1}$.
...
## Appendix: Tensor products in components
...
## Appendix: The Schmidt decomposition
