...
```{r choice-of-as-and-bs,echo=FALSE,cache=TRUE,engine='tikz',fig.width=1.5,fig.margin=TRUE,fig.cap='(ref:choice-of-as-and-bs-caption)',fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png'}
