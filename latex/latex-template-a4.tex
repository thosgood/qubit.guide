...
%% Headers and footers
\usepackage{fancyhdr}
\fancypagestyle{fancy}{\fancyhf{}\renewcommand{\headrulewidth}{0.5pt}\fancyhead[R]{\rightmark}\fancyfoot[C]{\small\thepage}}
\fancypagestyle{noheader}{\fancyhf{}\renewcommand{\headrulewidth}{0pt}\fancyfoot[C]{\small\thepage}}
\pagestyle{noheader} % we set \pagestyle{fancy} in index.Rmd, "Some mathematical preliminaries"
