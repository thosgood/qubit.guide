...
\hypersetup{
  ...
  pdfauthor={Artur Ekert, ed.~Tim Hosgood},
  hidelinks,
...
\date{Last updated: December 15, 2020}
...
\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-6-1.pdf}
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-10-1} \end{center}
...
\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-11-1.pdf}
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-13-1} \end{center}
...
\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-16-1.pdf}
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-17-1} \end{center}
...
\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-21-1.pdf}
...
Let me elaborate here on relations among single qubit unitary transformations, Pauli matrices and rotations of regular three dimensional vectors.
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-22-1} \end{center}
...
\[
  ...
  = \sum_{ij} c_i c^\star_j |a_i\rangle\langle a_j| \otimes \underbrace{|b_i\rangle\langle b_j|}_{\llap{$\mathrm{we\,will\,trace}$}\rlap{$\mathrm{\,this\,part\,only}$}}
\]
