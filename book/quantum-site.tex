...
\date{Last updated: December 16, 2020}
...
\hypertarget{quantum-interference-and-things-to-come}{%
\section{Quantum interference, and things to come}\label{quantum-interference-and-things-to-come}}

\begin{comment}

\href{../tufte/quantum-interference-and-things-to-come.html\#quantum-interference-and-things-to-come}{Click here to view this entire chapter on one page.}

\href{../book/quantum-interference-and-things-to-come.html\#quantum-interference-and-things-to-come}{Click here to view this chapter in the book.}
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-3-1} \end{center}
...
{\centering \includegraphics{quantum-site_files/figure-latex/ramsey-figure-1} 
...
{\centering \includegraphics{quantum-site_files/figure-latex/ramsey-figure-2-1} 
...
\begin{figure}
\centering
\includegraphics{quantum-site_files/figure-latex/interference-matrix-1.pdf}
\caption{\label{fig:interference-matrix}The Ramsey interferometer represented as an abstract diagram (matrix approach). Here we have omitted the \(|0\rangle\) and \(|1\rangle\) labels, just to simply the diagram. We also ignore the global phase factor of \(e^{i\frac{\varphi_0+\varphi_1}{2}}\).}
\end{figure}
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-4-1} \end{center}
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-5-1} \end{center}
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-6-1} \end{center}
...
\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-7-1.pdf}
...
{\centering \includegraphics{quantum-site_files/figure-latex/deterministic-computation-1} 
...
{\centering \includegraphics{quantum-site_files/figure-latex/probabilistic-computation-1} 
...
{\centering \includegraphics{quantum-site_files/figure-latex/quantum-computation-1} 
...
\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-8-1.pdf}
...
\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\item
  What does it mean to say that the field of complex numbers is \emph{algebraically closed}?
\item
...
{\centering \includegraphics{quantum-site_files/figure-latex/photons-from-stars-1} 
...
{\centering \includegraphics{quantum-site_files/figure-latex/sqrt-not-1} 
...
{\centering \includegraphics{quantum-site_files/figure-latex/bomb-detecting-scenario-1} 
...
{\centering \includegraphics{quantum-site_files/figure-latex/mach-zehnder-bomb-tester-1} 
...
\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-10-1.pdf}
...
\href{../tufte/qubits.html\#qubits}{Click here to view this entire chapter on one page.}

\href{../book/qubits.html\#qubits}{Click here to view this chapter in the book.}
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-11-1} \end{center}
...
\begin{figure}
\centering
\includegraphics{quantum-site_files/figure-latex/composition-of-two-computation-steps-1.pdf}
\caption{\label{fig:composition-of-two-computation-steps}The composition of two computational steps, \(U\) and \(V\), with the possible paths from \(|0\rangle\) to \(|1\rangle\) highlighted.}
\end{figure}
...
\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-12-1.pdf}
...
\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-13-1.pdf}
...
\[
  ...
  \end{bmatrix}
\]
That is, operation \(U\) sends state \(|\psi\rangle\), with components \(\alpha_k\), into state \(|\psi'\rangle=U|\psi\rangle\), with components \(\alpha'_l= \sum_k U_{lk}\alpha_k\).
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-14-1} \end{center}
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-15-1} \end{center}
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-16-1} \end{center}
...
\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-17-1.pdf}
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-18-1} \end{center}
...
One way or another, quantum theory explains the behaviour of \(\sqrt{\texttt{NOT}}\), and so, reassured by the physical experiments\footnote{We discuss this in more detail in \protect\hyperlink{appendix-physics-against-logic-via-beamsplitters}{Appendix: Physics against logic, via beamsplitters}.} that corroborate this theory, logicians are now entitled to propose a new logical operation \(\sqrt{\texttt{NOT}}\).
Why?
Because a faithful physical model for it exists in nature!
...
These three operators, combined with the identity, satisfy a lot of nice formal properties, which we shall examine briefly here, and the return to in more detail in \protect\hyperlink{linking-pauli-matrices-and-the-bloch-sphere}{Linking Pauli matrices and the Bloch sphere}.
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-19-1} \end{center}
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-20-1} \end{center}
...
{\centering \includegraphics{quantum-site_files/figure-latex/universal-circuit-for-2-by-2-1} 
...
{\centering \includegraphics{quantum-site_files/figure-latex/bloch-sphere-1} 
...
We call this sphere the \textbf{Bloch sphere}, and the unit vector \({\vec s}\) defined by \(\theta\) and \(\varphi\) the \textbf{Bloch vector}.\footnote{We will revisit this construction again in more detail, and from a slightly different point of view, in \protect\hyperlink{linking-pauli-matrices-and-the-bloch-sphere}{Linking Pauli matrices and the Bloch sphere}.}
...
{\centering \includegraphics{quantum-site_files/figure-latex/bloch-sphere-rotation-1} 
...
One can show\footnote{Again, see \protect\hyperlink{linking-pauli-matrices-and-the-bloch-sphere}{Linking Pauli matrices and the Bloch sphere}.} that the effect of the rotation represented by unitary \(U\) on the Bloch vector with components \(s_x\), \(s_y\), \(s_z\) is summarised in the formula
\[
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-21-1} \end{center}
...
For more details on all the above, see \protect\hyperlink{linking-pauli-matrices-and-the-bloch-sphere}{Linking Pauli matrices and the Bloch sphere}.

\hypertarget{appendix-physics-against-logic-via-beamsplitters}{%
\subsection{Appendix: Physics against logic, via beamsplitters}\label{appendix-physics-against-logic-via-beamsplitters}}
...
{\centering \includegraphics{quantum-site_files/figure-latex/beam-splitter-1} 
...
{\centering \includegraphics{quantum-site_files/figure-latex/two-beam-splitters-1} 
...
\begin{figure}
\centering
\includegraphics{quantum-site_files/figure-latex/classical-guess-double-beam-splitter-1.pdf}
\caption{\label{fig:classical-guess-double-beam-splitter}The two possible classical scenarios. Note that this is \textbf{not} what actually happens in the real physical world!}
\end{figure}
...
{\centering \includegraphics{quantum-site_files/figure-latex/paths-and-amplitudes-two-beam-splitters-1} 
...
\hypertarget{appendix-quantum-interference-revisited-still-about-beam-splitters}{%
\subsection{Appendix: Quantum interference revisited (still about beam-splitters)}\label{appendix-quantum-interference-revisited-still-about-beam-splitters}}
...
{\centering \includegraphics{quantum-site_files/figure-latex/mach-zehnder-1} 
...
\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-22-1.pdf}
...
{\centering \includegraphics{quantum-site_files/figure-latex/mach-zehnder-diagram-1} 
...
\hypertarget{linking-pauli-matrices-and-the-bloch-sphere}{%
\section{Linking Pauli matrices and the Bloch sphere}\label{linking-pauli-matrices-and-the-bloch-sphere}}

\begin{comment}

\href{../tufte/linking-pauli-matrices-and-the-bloch-sphere.html\#linking-pauli-matrices-and-the-bloch-sphere}{Click here to view this entire chapter on one page.}

\href{../book/linking-pauli-matrices-and-the-bloch-sphere.html\#linking-pauli-matrices-and-the-bloch-sphere}{Click here to view this chapter in the book.}
...
\href{../tufte/bells-theorem.html\#bells-theorem}{Click here to view this entire chapter on one page.}

\href{../book/bells-theorem.html\#bells-theorem}{Click here to view this chapter in the book.}
...
\begin{figure}
\centering
\includegraphics{quantum-site_files/figure-latex/choice-of-as-and-bs-1.pdf}
\caption{\label{fig:choice-of-as-and-bs}The relative angle between the two perpendicular pairs is \(45^\circ\).}
\end{figure}
...
\section{Decoherence, and elements of quantum error correction}\label{decoherence-and-elements-of-quantum-error-correction}}

\begin{comment}

\href{../tufte/decoherence-and-elements-of-quantum-error-correction.html\#decoherence-and-elements-of-quantum-error-correction}{Click here to view this entire chapter on one page.}

\href{../book/decoherence-and-elements-of-quantum-error-correction.html\#decoherence-and-elements-of-quantum-error-correction}{Click here to view this chapter in the book.}
...
{\centering \includegraphics{quantum-site_files/figure-latex/decoherence-interference-1} 
...
\begin{figure}
\centering
\includegraphics{quantum-site_files/figure-latex/visibility-suppression-1.pdf}
\caption{\label{fig:visibility-suppression}Visibility suppression.}
\end{figure}
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-23-1} \end{center}
...
\begin{center}\includegraphics{quantum-site_files/figure-latex/unnamed-chunk-24-1} \end{center}
...
\href{../tufte/density-matrices.html\#density-matrices}{Click here to view this entire chapter on one page.}

\href{../book/density-matrices.html\#density-matrices}{Click here to view this chapter in the book.}
...
In contrast, all other states, called \textbf{mixed states}, can be always written as the convex sum of pure states: \(\sum_i p_i |\psi_i\rangle\langle\psi_i|\) (\(p_i\geq 0\) and \(\sum_i p_i=1\)).
...
\section{Quantum channels (or CP maps)}\label{quantum-channels-or-cp-maps}}
...
\hypertarget{bonus-things}{%
\section{Bonus things}\label{bonus-things}}
